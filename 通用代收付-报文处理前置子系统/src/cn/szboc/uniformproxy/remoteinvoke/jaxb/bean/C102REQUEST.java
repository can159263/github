...
@XmlRootElement(name = "C102_REQUEST", namespace = "http://www.szboc.cn/projects/open/2012/UniformProxySystem")
public class C102REQUEST extends CommonRequestMessage{
    ...
    protected C102REQUEST.BODY body;
     ...
     * @return
     *     possible object is
     *     {@link C102REQUEST.BODY }
     *     
     */
    public C102REQUEST.BODY getBODY() {
        return body;
    }
     ...
     *     
     */
    public void setBODY(C102REQUEST.BODY value) {
        this.body = value;
    }
