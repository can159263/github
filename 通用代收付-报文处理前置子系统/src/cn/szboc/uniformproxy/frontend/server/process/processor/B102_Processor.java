...
@Component("B102_Processor")
public class B102_Processor extends Processor {
	...
	public CommonResponseMessage process(CommonRequestMessage request) throws Exception {
		return service.dealMsgB102((B102REQUEST) request);
	}
	 ...
	 */
	@Override
	protected B102RESPONSE getDefaultResposne() {
		B102RESPONSE response = of.createB102RESPONSE();
