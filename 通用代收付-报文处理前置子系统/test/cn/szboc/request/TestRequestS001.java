...
public class TestRequestS001 {
	...
	public void test() throws Exception {
		...
		File file = new File("F:/Projects/快付通代收代付系统/设计文档/通信报文规则/统一/xml与xsd/C001_request.xml");
		...
		//按照顺序拼接多个数组，并返回
		byte[] finalData = ByteUtils.byteJoin("S001".getBytes(), headData, data);
