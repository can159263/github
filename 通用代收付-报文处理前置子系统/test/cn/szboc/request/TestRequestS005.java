...
public class TestRequestS005 {

	private byte[] key = { 81, 97, -116, 76, 7, 124, -60, 74 };
	
	@Test
	public void test() throws Exception {
		
		File file = new File("F:/Projects/快付通代收代付系统/设计文档/通信报文规则/统一/xml与xsd/A001_request.xml");
		
		//file = new File("F:/Projects/快付通代收代付系统/jar/recv_20120906044436_020120906035700sss090702633789_RDNWOBejKStreWXoYxqB_B001.xml");
		...
		//按照顺序拼接多个数组，并返回
		byte[] finalData = ByteUtils.byteJoin("S005".getBytes(), headData, data);
...
//		Socket s = new Socket("22.145.27.92", 15000);
		...
		FileUtils.writeByteArrayToFile(new File("F:/Projects/快付通代收代付系统/设计文档/通信报文规则/统一/xml与xsd/A001_request.all_raw"), response);
