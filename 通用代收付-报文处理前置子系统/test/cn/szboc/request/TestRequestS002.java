...
public class TestRequestS002 {

	//private byte[] key = { 52, 55, 98, 25, 37, 124, 98, 121 };
	private byte[] key = { 7, 115, 56, -51, 124, -83, 76, -108 };

	@Test
	public void test() throws Exception {
		
		File file = new File("E:/document/KFT/xml与xsd/A001_request.xml");
