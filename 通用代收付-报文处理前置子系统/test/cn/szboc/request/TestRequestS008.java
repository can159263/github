...
public class TestRequestS008 {

	private byte[] key = {-104, -104, 112, -116, 115, 56, -5, -32};
	
	@Test
	public void test() throws Exception {
		
		File file = new File("F:/Projects/快付通代收代付系统/设计文档/通信报文规则/统一/xml与xsd/B101_request.xml");
		...
		//按照顺序拼接多个数组，并返回
		byte[] finalData = ByteUtils.byteJoin("S008".getBytes(), headData, data);
