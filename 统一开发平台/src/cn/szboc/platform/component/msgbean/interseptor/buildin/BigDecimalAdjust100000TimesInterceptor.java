...
/**
 * 扩大金额100000倍的BigDecimal拦截器
 * 针对BigDecimal字段格式修正 小数点去除,金额的浮点数扩大/缩小100000倍,具体为
 * 把从BigDecimal属性中取到的数值扩大100000倍,方便传到CSP进行账务交易
 * 在BigDecimal属性被设置后,金额缩小100000倍,方便从CSP返回的(默认5位小数)金额格式解析
 */
public class BigDecimalAdjust100000TimesInterceptor implements BeforeGetInterceptor, AfterSetInterceptor {

	/**
	 * 默认浮点数的标度
	 */
	private static final int scaleSize = 5;
